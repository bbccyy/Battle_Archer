...
/*FOR2LUA
<Record>
	<name>TActUnionRechargeBackScoreChangeNotify</name>
	<Function>
		<name>CopyFrom</name>
		<replaceName>MergeFrom</replaceName>
		<handler>descripter = pb_copyfrom_cpp()</handler>
...
FOR2LUA*/
class TActUnionRechargeBackScoreChangeNotify : public ::google::protobuf::Message {
 public:
  TActUnionRechargeBackScoreChangeNotify();
  virtual ~TActUnionRechargeBackScoreChangeNotify();

  TActUnionRechargeBackScoreChangeNotify(const TActUnionRechargeBackScoreChangeNotify& from);

  inline TActUnionRechargeBackScoreChangeNotify& operator=(const TActUnionRechargeBackScoreChangeNotify& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const TActUnionRechargeBackScoreChangeNotify& default_instance();

  void Swap(TActUnionRechargeBackScoreChangeNotify* other);

  // implements Message ----------------------------------------------

  TActUnionRechargeBackScoreChangeNotify* New() const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const TActUnionRechargeBackScoreChangeNotify& from);
  void MergeFrom(const TActUnionRechargeBackScoreChangeNotify& from);
  void Clear();
  bool IsInitialized() const;
  ...
  <Record>
  	...
  	<Function>
  		<name>userscore</name>
  		<replaceName>UserScore</replaceName>
  		<handler>descripter = pb_cpp()</handler>
  	</Function>
  	<Function>
  		<name>set_userscore</name>
  		<replaceName>UserScore</replaceName>
  		<handler>descripter = pb_set_cpp()</handler>
  	</Function>
  	<Function>
  		<name>has_userscore</name>
  		<replaceName>UserScore</replaceName>
  		<handler>descripter = pb_has_cpp()</handler>
  	</Function>
  </Record>
  FOR2LUA*/
  inline ::google::protobuf::uint32 userscore() const;
  inline void set_userscore(::google::protobuf::uint32 value);

  // optional uint32 AllyScore = 2;
  inline bool has_allyscore() const;
  inline void clear_allyscore();
  static const int kAllyScoreFieldNumber = 2;
  /*FOR2LUA
  <Record>
  	<name>TActUnionRechargeBackScoreChangeNotify</name>
  	<Function>
  ...
  inline bool has_userallyscore() const;
  inline void clear_userallyscore();
  static const int kUserAllyScoreFieldNumber = 3;
  /*FOR2LUA
  <Record>
  	<name>TActUnionRechargeBackScoreChangeNotify</name>
  	<Function>
  ...
  // @@protoc_insertion_point(class_scope:pb.TActUnionRechargeBackScoreChangeNotify)
 private:
  ...
  ::google::protobuf::uint32 _has_bits_[1];
  mutable int _cached_size_;
  ::google::protobuf::uint32 userscore_;
...
// optional uint32 UserScore = 1;
inline bool TActUnionRechargeBackScoreChangeNotify::has_userscore() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void TActUnionRechargeBackScoreChangeNotify::set_has_userscore() {
  _has_bits_[0] |= 0x00000001u;
}
inline void TActUnionRechargeBackScoreChangeNotify::clear_has_userscore() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void TActUnionRechargeBackScoreChangeNotify::clear_userscore() {
  userscore_ = 0u;
  clear_has_userscore();
}
inline ::google::protobuf::uint32 TActUnionRechargeBackScoreChangeNotify::userscore() const {
  // @@protoc_insertion_point(field_get:pb.TActUnionRechargeBackScoreChangeNotify.UserScore)
  return userscore_;
}
inline void TActUnionRechargeBackScoreChangeNotify::set_userscore(::google::protobuf::uint32 value) {
  set_has_userscore();
  userscore_ = value;
  // @@protoc_insertion_point(field_set:pb.TActUnionRechargeBackScoreChangeNotify.UserScore)
}

// optional uint32 AllyScore = 2;
inline bool TActUnionRechargeBackScoreChangeNotify::has_allyscore() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void TActUnionRechargeBackScoreChangeNotify::set_has_allyscore() {
  _has_bits_[0] |= 0x00000002u;
}
inline void TActUnionRechargeBackScoreChangeNotify::clear_has_allyscore() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void TActUnionRechargeBackScoreChangeNotify::clear_allyscore() {
  allyscore_ = 0u;
  clear_has_allyscore();
}
inline ::google::protobuf::uint32 TActUnionRechargeBackScoreChangeNotify::allyscore() const {
  // @@protoc_insertion_point(field_get:pb.TActUnionRechargeBackScoreChangeNotify.AllyScore)
  return allyscore_;
}
inline void TActUnionRechargeBackScoreChangeNotify::set_allyscore(::google::protobuf::uint32 value) {
  set_has_allyscore();
  allyscore_ = value;
  // @@protoc_insertion_point(field_set:pb.TActUnionRechargeBackScoreChangeNotify.AllyScore)
}

// optional uint32 UserAllyScore = 3;
inline bool TActUnionRechargeBackScoreChangeNotify::has_userallyscore() const {
  return (_has_bits_[0] & 0x00000004u) != 0;
}
inline void TActUnionRechargeBackScoreChangeNotify::set_has_userallyscore() {
  _has_bits_[0] |= 0x00000004u;
}
inline void TActUnionRechargeBackScoreChangeNotify::clear_has_userallyscore() {
  _has_bits_[0] &= ~0x00000004u;
}
inline void TActUnionRechargeBackScoreChangeNotify::clear_userallyscore() {
  userallyscore_ = 0u;
  clear_has_userallyscore();
}
inline ::google::protobuf::uint32 TActUnionRechargeBackScoreChangeNotify::userallyscore() const {
  // @@protoc_insertion_point(field_get:pb.TActUnionRechargeBackScoreChangeNotify.UserAllyScore)
  return userallyscore_;
}
inline void TActUnionRechargeBackScoreChangeNotify::set_userallyscore(::google::protobuf::uint32 value) {
  set_has_userallyscore();
  userallyscore_ = value;
