...
class TDefineChallengeGetBaseInfoRsp : public ::google::protobuf::Message {
 public:
  ...
  static const int kWarZoneIdFieldNumber = 4;
  /*FOR2LUA
  <Record>
  	<name>TDefineChallengeGetBaseInfoRsp</name>
  	<Function>
  ...
  static const int kMaxFightForceFieldNumber = 8;
  /*FOR2LUA
  <Record>
  	<name>TDefineChallengeGetBaseInfoRsp</name>
  	<Function>
  ...
  static const int kGroupRankFieldNumber = 9;
  /*FOR2LUA
  <Record>
  	<name>TDefineChallengeGetBaseInfoRsp</name>
  	<Function>
  ...
  static const int kWarZoneRankFieldNumber = 10;
  /*FOR2LUA
  <Record>
  	<name>TDefineChallengeGetBaseInfoRsp</name>
  	<Function>
  ...
  inline bool has_bossinfo() const;
  inline void clear_bossinfo();
  static const int kBossInfoFieldNumber = 11;
  /*FOR2LUA
  <Record>
  	<name>TDefineChallengeGetBaseInfoRsp</name>
  	<Function>
...
class TDefineChallengeChangeBossRsp : public ::google::protobuf::Message {
 public:
  ...
  inline bool has_grouprank() const;
  inline void clear_grouprank();
  static const int kGroupRankFieldNumber = 2;
  /*FOR2LUA
  <Record>
  	<name>TDefineChallengeChangeBossRsp</name>
  	<Function>
  ...
  inline bool has_warzonerank() const;
  inline void clear_warzonerank();
  static const int kWarZoneRankFieldNumber = 3;
  /*FOR2LUA
  <Record>
  	<name>TDefineChallengeChangeBossRsp</name>
  	<Function>
...
// repeated .pb.TDefineChallengeExpectProcess ArrExpectProcess = 1;
inline int TDefineChallengeGetBaseInfoRsp::arrexpectprocess_size() const {
  return arrexpectprocess_.size();
}
inline void TDefineChallengeGetBaseInfoRsp::clear_arrexpectprocess() {
  arrexpectprocess_.Clear();
}
inline const ::pb::TDefineChallengeExpectProcess& TDefineChallengeGetBaseInfoRsp::arrexpectprocess(int index) const {
  // @@protoc_insertion_point(field_get:pb.TDefineChallengeGetBaseInfoRsp.ArrExpectProcess)
  return arrexpectprocess_.Get(index);
}
inline ::pb::TDefineChallengeExpectProcess* TDefineChallengeGetBaseInfoRsp::mutable_arrexpectprocess(int index) {
  // @@protoc_insertion_point(field_mutable:pb.TDefineChallengeGetBaseInfoRsp.ArrExpectProcess)
  return arrexpectprocess_.Mutable(index);
}
inline ::pb::TDefineChallengeExpectProcess* TDefineChallengeGetBaseInfoRsp::add_arrexpectprocess() {
  // @@protoc_insertion_point(field_add:pb.TDefineChallengeGetBaseInfoRsp.ArrExpectProcess)
  return arrexpectprocess_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::pb::TDefineChallengeExpectProcess >&
TDefineChallengeGetBaseInfoRsp::arrexpectprocess() const {
  // @@protoc_insertion_point(field_list:pb.TDefineChallengeGetBaseInfoRsp.ArrExpectProcess)
  return arrexpectprocess_;
}
inline ::google::protobuf::RepeatedPtrField< ::pb::TDefineChallengeExpectProcess >*
TDefineChallengeGetBaseInfoRsp::mutable_arrexpectprocess() {
  // @@protoc_insertion_point(field_mutable_list:pb.TDefineChallengeGetBaseInfoRsp.ArrExpectProcess)
  return &arrexpectprocess_;
}

// optional bool FuncOpen = 2;
inline bool TDefineChallengeGetBaseInfoRsp::has_funcopen() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void TDefineChallengeGetBaseInfoRsp::set_has_funcopen() {
  _has_bits_[0] |= 0x00000002u;
}
inline void TDefineChallengeGetBaseInfoRsp::clear_has_funcopen() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void TDefineChallengeGetBaseInfoRsp::clear_funcopen() {
  funcopen_ = false;
  clear_has_funcopen();
}
inline bool TDefineChallengeGetBaseInfoRsp::funcopen() const {
  // @@protoc_insertion_point(field_get:pb.TDefineChallengeGetBaseInfoRsp.FuncOpen)
  return funcopen_;
}
inline void TDefineChallengeGetBaseInfoRsp::set_funcopen(bool value) {
  set_has_funcopen();
  funcopen_ = value;
  // @@protoc_insertion_point(field_set:pb.TDefineChallengeGetBaseInfoRsp.FuncOpen)
}

// optional .pb.TDefineChallengeActualProcess ActualProcess = 3;
inline bool TDefineChallengeGetBaseInfoRsp::has_actualprocess() const {
  return (_has_bits_[0] & 0x00000004u) != 0;
}
inline void TDefineChallengeGetBaseInfoRsp::set_has_actualprocess() {
  _has_bits_[0] |= 0x00000004u;
}
inline void TDefineChallengeGetBaseInfoRsp::clear_has_actualprocess() {
  _has_bits_[0] &= ~0x00000004u;
}
inline void TDefineChallengeGetBaseInfoRsp::clear_actualprocess() {
  if (actualprocess_ != NULL) actualprocess_->::pb::TDefineChallengeActualProcess::Clear();
  clear_has_actualprocess();
}
inline const ::pb::TDefineChallengeActualProcess& TDefineChallengeGetBaseInfoRsp::actualprocess() const {
  // @@protoc_insertion_point(field_get:pb.TDefineChallengeGetBaseInfoRsp.ActualProcess)
  return actualprocess_ != NULL ? *actualprocess_ : *default_instance_->actualprocess_;
}
inline ::pb::TDefineChallengeActualProcess* TDefineChallengeGetBaseInfoRsp::mutable_actualprocess() {
  set_has_actualprocess();
  if (actualprocess_ == NULL) actualprocess_ = new ::pb::TDefineChallengeActualProcess;
  // @@protoc_insertion_point(field_mutable:pb.TDefineChallengeGetBaseInfoRsp.ActualProcess)
  return actualprocess_;
}
inline ::pb::TDefineChallengeActualProcess* TDefineChallengeGetBaseInfoRsp::release_actualprocess() {
  clear_has_actualprocess();
  ::pb::TDefineChallengeActualProcess* temp = actualprocess_;
  actualprocess_ = NULL;
  return temp;
}
inline void TDefineChallengeGetBaseInfoRsp::set_allocated_actualprocess(::pb::TDefineChallengeActualProcess* actualprocess) {
  ...
  // @@protoc_insertion_point(field_set_allocated:pb.TDefineChallengeGetBaseInfoRsp.ActualProcess)
}
...
// optional uint32 GroupRank = 2;
inline bool TDefineChallengeChangeBossRsp::has_grouprank() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void TDefineChallengeChangeBossRsp::set_has_grouprank() {
  _has_bits_[0] |= 0x00000002u;
}
inline void TDefineChallengeChangeBossRsp::clear_has_grouprank() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void TDefineChallengeChangeBossRsp::clear_grouprank() {
  grouprank_ = 0u;
  clear_has_grouprank();
}
inline ::google::protobuf::uint32 TDefineChallengeChangeBossRsp::grouprank() const {
  // @@protoc_insertion_point(field_get:pb.TDefineChallengeChangeBossRsp.GroupRank)
  return grouprank_;
}
inline void TDefineChallengeChangeBossRsp::set_grouprank(::google::protobuf::uint32 value) {
  set_has_grouprank();
  grouprank_ = value;
  // @@protoc_insertion_point(field_set:pb.TDefineChallengeChangeBossRsp.GroupRank)
}

// optional uint32 WarZoneRank = 3;
inline bool TDefineChallengeChangeBossRsp::has_warzonerank() const {
  return (_has_bits_[0] & 0x00000004u) != 0;
}
inline void TDefineChallengeChangeBossRsp::set_has_warzonerank() {
  _has_bits_[0] |= 0x00000004u;
}
inline void TDefineChallengeChangeBossRsp::clear_has_warzonerank() {
  _has_bits_[0] &= ~0x00000004u;
}
inline void TDefineChallengeChangeBossRsp::clear_warzonerank() {
  warzonerank_ = 0u;
  clear_has_warzonerank();
}
inline ::google::protobuf::uint32 TDefineChallengeChangeBossRsp::warzonerank() const {
  // @@protoc_insertion_point(field_get:pb.TDefineChallengeChangeBossRsp.WarZoneRank)
  return warzonerank_;
}
inline void TDefineChallengeChangeBossRsp::set_warzonerank(::google::protobuf::uint32 value) {
  set_has_warzonerank();
  warzonerank_ = value;
  // @@protoc_insertion_point(field_set:pb.TDefineChallengeChangeBossRsp.WarZoneRank)
}
